...
static const int pickerViewHeight = 300;
...
- (UIButton *)confirmButton{
    if (!_confirmButton) {
        ...
        _confirmButton.titleLabel.font = H15;
...
- (UIButton *)cancelButton{
    if (!_cancelButton) {
        ...
        _cancelButton.titleLabel.font =H15;
...
- (UIPickerView *)pickerView{
    if (!_pickerView) {
        _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 40, SCREEN_WIDTH, pickerViewHeight - 40)];
