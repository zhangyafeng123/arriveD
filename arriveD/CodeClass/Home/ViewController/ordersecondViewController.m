...
@interface ordersecondViewController ()<AMapLocationManagerDelegate,MAMapViewDelegate>
...
@implementation ordersecondViewController
...
- (void)viewDidLoad {
    ...
    //设置地图
    [self setmap];
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem initWithTitle:@"刷新" titleColor:[UIColor grayColor] target:self action:@selector(rightbaraction)];
}
- (void)setmap
{
